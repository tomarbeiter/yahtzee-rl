from yahtzee_singleV9 import YahtzeeSinglePlayerV9
import math
from agentv9 import AgentV9
import time

env = YahtzeeSinglePlayerV9()
agent = AgentV9(1, 0.5, 0.1)
...
agent.write_data("./data/agentv9/envV9/10kv9.txt")
agent.generate_plot("./data/agentv9/envV9/10kv9.png")
