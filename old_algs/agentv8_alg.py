from yahtzee_singleV8 import YahtzeeSinglePlayerV8
import math
from agentv8 import AgentV8
import time

env = YahtzeeSinglePlayerV8()
agent = AgentV8(1, 0.5, 0.1)
...
agent.write_data("./data/agentv8/envV8/10kv8.txt")
agent.generate_plot("./data/agentv8/envV8/10kv8.png")
